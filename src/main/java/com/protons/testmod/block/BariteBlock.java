...
public class BariteBlock extends Block {
	public static final MapCodec<BariteBlock> CODEC = createCodec(BariteBlock::new);

	@Override
	public MapCodec<? extends BariteBlock> getCodec() {
		return CODEC;
	}

	public BariteBlock(Settings settings) {
		super(settings);
	}
