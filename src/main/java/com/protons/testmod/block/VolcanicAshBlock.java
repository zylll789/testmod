...
public class VolcanicAshBlock extends Block {
	public static final MapCodec<VolcanicAshBlock> CODEC = createCodec(VolcanicAshBlock::new);
	...
	@Override
	public MapCodec<VolcanicAshBlock> getCodec() {
		return CODEC;
	}

	public VolcanicAshBlock(Settings settings) {
		super(settings);
	...
	protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
		...
		if (blockState.isIn(ModBlockTags.VOLCANIC_ASH_LAYER_CANNOT_SURVIVE_ON)) {
			return false;
		} else {
			return blockState.isIn(ModBlockTags.VOLCANIC_ASH_LAYER_CAN_SURVIVE_ON)
				? true
