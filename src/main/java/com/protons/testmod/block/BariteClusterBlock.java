...
public class BariteClusterBlock extends BariteBlock implements Waterloggable {
	public static final MapCodec<BariteClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
		instance -> instance.group(
				...
				.apply(instance, BariteClusterBlock::new)
	);
	...
	@Override
	public MapCodec<BariteClusterBlock> getCodec() {
		return CODEC;
	}

	public BariteClusterBlock(float height, float xzOffset, Settings settings) {
		super(settings);
