...
public class SulfurClusterBlock extends SulfurBlock implements Waterloggable {
	public static final MapCodec<SulfurClusterBlock> CODEC = RecordCodecBuilder.mapCodec(
		instance -> instance.group(
				...
				.apply(instance, SulfurClusterBlock::new)
	);
	...
	@Override
	public MapCodec<SulfurClusterBlock> getCodec() {
		return CODEC;
	}

	public SulfurClusterBlock(float height, float xzOffset, Settings settings) {
		super(settings);
